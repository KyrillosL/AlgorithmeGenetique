...
list_time=[]
for i in range(6):
    time,score = ag.solve(method=i, realtime_plot=False, refresh_rate_plot=1, realtime_counter=True,refresh_rate_counter=1,  keep_degrading=True, one_indiv=False, stop_after=10000, number_of_pass=20)
