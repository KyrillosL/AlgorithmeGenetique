...
ag.solve(4, realtime_plot=True, refresh_rate_plot=1000, realtime_counter=True,refresh_rate_counter=parametres_algo["taille_agent"]/10,  keep_degrading=True, one_indiv=False)
